...
class GetMarginAttributesResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["amount_of_missing_funds", b"amount_of_missing_funds", "corrected_margin", b"corrected_margin", "funds_sufficiency_level", b"funds_sufficiency_level", "guarantee_for_futures", b"guarantee_for_futures", "liquid_portfolio", b"liquid_portfolio", "minimal_margin", b"minimal_margin", "starting_margin", b"starting_margin"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["amount_of_missing_funds", b"amount_of_missing_funds", "corrected_margin", b"corrected_margin", "funds_sufficiency_level", b"funds_sufficiency_level", "guarantee_for_futures", b"guarantee_for_futures", "liquid_portfolio", b"liquid_portfolio", "minimal_margin", b"minimal_margin", "starting_margin", b"starting_margin"]) -> None: ...
...
class UnaryLimit(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_limit_per_second", b"_limit_per_second", "limit_per_second", b"limit_per_second"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_limit_per_second", b"_limit_per_second", "limit_per_minute", b"limit_per_minute", "limit_per_second", b"limit_per_second", "methods", b"methods"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_limit_per_second", b"_limit_per_second"]) -> typing_extensions.Literal["limit_per_second"] | None: ...
...
class GetInfoResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["prem_status", b"prem_status", "qual_status", b"qual_status", "qualified_for_work_with", b"qualified_for_work_with", "risk_level_code", b"risk_level_code", "tariff", b"tariff", "user_id", b"user_id"]) -> None: ...
...
class GetBankAccountsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bank_accounts", b"bank_accounts"]) -> None: ...
...
class BankAccount(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["opened_date", b"opened_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "money", b"money", "name", b"name", "opened_date", b"opened_date", "type", b"type"]) -> None: ...
...
class CurrencyTransferRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["amount", b"amount", "from_account_id", b"from_account_id", "to_account_id", b"to_account_id", "transaction_id", b"transaction_id"]) -> None: ...
...
class PayInRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["amount", b"amount"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["amount", b"amount", "from_account_id", b"from_account_id", "to_account_id", b"to_account_id"]) -> None: ...
...
class GetAccountValuesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accounts", b"accounts", "values", b"values"]) -> None: ...
...
class AccountValuesWithParameters(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "values", b"values"]) -> None: ...
