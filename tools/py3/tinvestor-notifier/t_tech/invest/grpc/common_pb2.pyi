...
class PingRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_time", b"_time", "time", b"time"]) -> None: ...
...
class PingDelaySettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_ping_delay_ms", b"_ping_delay_ms", "ping_delay_ms", b"ping_delay_ms"]) -> None: ...
...
class Ping(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_ping_request_time", b"_ping_request_time", "ping_request_time", b"ping_request_time", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_ping_request_time", b"_ping_request_time", "ping_request_time", b"ping_request_time", "stream_id", b"stream_id", "time", b"time"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_ping_request_time", b"_ping_request_time"]) -> typing_extensions.Literal["ping_request_time"] | None: ...
