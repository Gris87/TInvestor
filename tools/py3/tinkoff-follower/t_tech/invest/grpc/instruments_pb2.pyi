...
class FilterOptionsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_basic_asset_position_uid", b"_basic_asset_position_uid", "_basic_asset_uid", b"_basic_asset_uid", "_basic_instrument_id", b"_basic_instrument_id", "basic_asset_position_uid", b"basic_asset_position_uid", "basic_asset_uid", b"basic_asset_uid", "basic_instrument_id", b"basic_instrument_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_basic_asset_position_uid", b"_basic_asset_position_uid", "_basic_asset_uid", b"_basic_asset_uid", "_basic_instrument_id", b"_basic_instrument_id", "basic_asset_position_uid", b"basic_asset_position_uid", "basic_asset_uid", b"basic_asset_uid", "basic_instrument_id", b"basic_instrument_id"]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_basic_instrument_id", b"_basic_instrument_id"]) -> typing_extensions.Literal["basic_instrument_id"] | None: ...
...
class NewsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_cursor", b"_cursor", "_limit", b"_limit", "cursor", b"cursor", "limit", b"limit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_cursor", b"_cursor", "_limit", b"_limit", "cursor", b"cursor", "limit", b"limit"]) -> None: ...
    @typing.overload
...
class NewsResponse(google.protobuf.message.Message):
    ...
    next_cursor: builtins.int
    """Следующий курсор."""
    @property
    def items(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___NewsItem]:
        """Массив новостей."""
    def __init__(
        self,
        *,
        has_next: builtins.bool = ...,
        next_cursor: builtins.int | None = ...,
        items: collections.abc.Iterable[global___NewsItem] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_next_cursor", b"_next_cursor", "next_cursor", b"next_cursor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_next_cursor", b"_next_cursor", "has_next", b"has_next", "items", b"items", "next_cursor", b"next_cursor"]) -> None: ...
...
class NewsItem(google.protobuf.message.Message):
    ...
    def tables(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Table]:
        """Табличные данные."""
    @property
    def instrument_id(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___NewsInstrument]:
    ...
    def __init__(
        ...
        *,
        ...
        instrument_id: collections.abc.Iterable[global___NewsInstrument] | None = ...,
        priority: builtins.bool = ...,
        ts: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_summary", b"_summary", "summary", b"summary", "ts", b"ts"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_summary", b"_summary", "content", b"content", "id", b"id", "instrument_id", b"instrument_id", "priority", b"priority", "source", b"source", "summary", b"summary", "tables", b"tables", "title", b"title", "ts", b"ts"]) -> None: ...
...
@typing_extensions.final
class NewsInstrument(google.protobuf.message.Message):
    ...
    INSTRUMENT_FIELD_NUMBER: builtins.int
    @property
    def instrument(self) -> global___NewsInstrumentInfo:
        """Информация по инструменту."""
    def __init__(
        self,
        *,
        instrument: global___NewsInstrumentInfo | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["instrument", b"instrument"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["instrument", b"instrument"]) -> None: ...

global___NewsInstrument = NewsInstrument

@typing_extensions.final
class NewsInstrumentInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "instrument_uid", b"instrument_uid", "ticker", b"ticker"]) -> None: ...

global___NewsInstrumentInfo = NewsInstrumentInfo
...
class StructuredNote(google.protobuf.message.Message):
    ...
    class BasicAsset(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["initial_price", b"initial_price"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["initial_price", b"initial_price", "type", b"type", "uid", b"uid"]) -> None: ...
...
class AssetsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_instrument_status", b"_instrument_status", "_instrument_type", b"_instrument_type", "instrument_status", b"instrument_status", "instrument_type", b"instrument_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_instrument_status", b"_instrument_status", "_instrument_type", b"_instrument_type", "instrument_status", b"instrument_status", "instrument_type", b"instrument_type"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_instrument_status", b"_instrument_status"]) -> typing_extensions.Literal["instrument_status"] | None: ...
    @typing.overload
...
class GetFavoritesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_group_id", b"_group_id", "group_id", b"group_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_group_id", b"_group_id", "group_id", b"group_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_group_id", b"_group_id"]) -> typing_extensions.Literal["group_id"] | None: ...
...
class GetFavoritesResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_group_id", b"_group_id", "group_id", b"group_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_group_id", b"_group_id", "favorite_instruments", b"favorite_instruments", "group_id", b"group_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_group_id", b"_group_id"]) -> typing_extensions.Literal["group_id"] | None: ...
...
class EditFavoritesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_group_id", b"_group_id", "group_id", b"group_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_group_id", b"_group_id", "action_type", b"action_type", "group_id", b"group_id", "instruments", b"instruments"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_group_id", b"_group_id"]) -> typing_extensions.Literal["group_id"] | None: ...
...
class CreateFavoriteGroupRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_note", b"_note", "note", b"note"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_note", b"_note", "group_color", b"group_color", "group_name", b"group_name", "note", b"note"]) -> None: ...
...
class GetFavoriteGroupsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["excluded_group_id", b"excluded_group_id", "instrument_id", b"instrument_id"]) -> None: ...
...
class GetFavoriteGroupsResponse(google.protobuf.message.Message):
    ...
    class FavoriteGroup(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_contains_instrument", b"_contains_instrument", "contains_instrument", b"contains_instrument"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_contains_instrument", b"_contains_instrument", "color", b"color", "contains_instrument", b"contains_instrument", "group_id", b"group_id", "group_name", b"group_name", "size", b"size"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_contains_instrument", b"_contains_instrument"]) -> typing_extensions.Literal["contains_instrument"] | None: ...
...
class IndicativeResponse(google.protobuf.message.Message):
    ...
    BUY_AVAILABLE_FLAG_FIELD_NUMBER: builtins.int
    SELL_AVAILABLE_FLAG_FIELD_NUMBER: builtins.int
    INDEX_COMPOSITION_FIELD_NUMBER: builtins.int
    figi: builtins.str
    """FIGI-идентификатор инструмента."""
    ticker: builtins.str
    """Тикер инструмента."""
    ...
    """Признак доступности для продажи."""
    @property
    def index_composition(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___IndexInstrument]:
        """Состав индекса."""
    def __init__(
        self,
        *,
        ...
        buy_available_flag: builtins.bool = ...,
        sell_available_flag: builtins.bool = ...,
        index_composition: collections.abc.Iterable[global___IndexInstrument] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["buy_available_flag", b"buy_available_flag", "class_code", b"class_code", "currency", b"currency", "exchange", b"exchange", "figi", b"figi", "index_composition", b"index_composition", "instrument_kind", b"instrument_kind", "name", b"name", "sell_available_flag", b"sell_available_flag", "ticker", b"ticker", "uid", b"uid"]) -> None: ...

global___IndicativeResponse = IndicativeResponse

@typing_extensions.final
class IndexInstrument(google.protobuf.message.Message):
    ...
    """Идентификатор инструмента."""
    @property
    def weight(self) -> t_tech.invest.grpc.common_pb2.Quotation:
        """Вес инструмента в составе индекса в %."""
    def __init__(
        self,
        *,
        uid: builtins.str = ...,
        weight: t_tech.invest.grpc.common_pb2.Quotation | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["weight", b"weight"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["uid", b"uid", "weight", b"weight"]) -> None: ...

global___IndexInstrument = IndexInstrument
...
class RiskRatesResponse(google.protobuf.message.Message):
    ...
    class RiskRateResult(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_error", b"_error", "_long_risk_rate", b"_long_risk_rate", "_short_risk_rate", b"_short_risk_rate", "error", b"error", "long_risk_rate", b"long_risk_rate", "short_risk_rate", b"short_risk_rate"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_error", b"_error", "_long_risk_rate", b"_long_risk_rate", "_short_risk_rate", b"_short_risk_rate", "error", b"error", "instrument_uid", b"instrument_uid", "long_risk_rate", b"long_risk_rate", "long_risk_rates", b"long_risk_rates", "short_risk_rate", b"short_risk_rate", "short_risk_rates", b"short_risk_rates"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_error", b"_error"]) -> typing_extensions.Literal["error"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_long_risk_rate", b"_long_risk_rate"]) -> typing_extensions.Literal["long_risk_rate"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_short_risk_rate", b"_short_risk_rate"]) -> typing_extensions.Literal["short_risk_rate"] | None: ...
    ...
    class RiskRate(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["value", b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["risk_level_code", b"risk_level_code", "value", b"value"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["instrument_risk_rates", b"instrument_risk_rates"]) -> None: ...
...
class GetInsiderDealsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_next_cursor", b"_next_cursor", "next_cursor", b"next_cursor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_next_cursor", b"_next_cursor", "instrument_id", b"instrument_id", "limit", b"limit", "next_cursor", b"next_cursor"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_next_cursor", b"_next_cursor"]) -> typing_extensions.Literal["next_cursor"] | None: ...
...
class GetInsiderDealsResponse(google.protobuf.message.Message):
    ...
    class InsiderDeal(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["date", b"date", "disclosure_date", b"disclosure_date", "price", b"price"]) -> builtins.bool: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["_next_cursor", b"_next_cursor", "next_cursor", b"next_cursor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_next_cursor", b"_next_cursor", "insider_deals", b"insider_deals", "next_cursor", b"next_cursor"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_next_cursor", b"_next_cursor"]) -> typing_extensions.Literal["next_cursor"] | None: ...
...
class DfaResponse(google.protobuf.message.Message):
    ...
    class ForecastYield(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["max_value", b"max_value", "min_value", b"min_value"]) -> None: ...
