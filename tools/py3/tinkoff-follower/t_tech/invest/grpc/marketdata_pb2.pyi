...
class MarketDataRequest(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["payload", b"payload"]) -> typing_extensions.Literal["subscribe_candles_request", "subscribe_order_book_request", "subscribe_trades_request", "subscribe_info_request", "subscribe_last_price_request", "get_my_subscriptions", "ping", "ping_settings"] | None: ...
...
class SubscribeCandlesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_candle_source_type", b"_candle_source_type", "candle_source_type", b"candle_source_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_candle_source_type", b"_candle_source_type", "candle_source_type", b"candle_source_type", "instruments", b"instruments", "subscription_action", b"subscription_action", "waiting_close", b"waiting_close"]) -> None: ...
...
class SubscribeTradesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["instruments", b"instruments", "subscription_action", b"subscription_action", "trade_source", b"trade_source", "with_open_interest", b"with_open_interest"]) -> None: ...
...
class SubscribeTradesResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["tracking_id", b"tracking_id", "trade_source", b"trade_source", "trade_subscriptions", b"trade_subscriptions"]) -> None: ...
...
class TradeSubscription(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "figi", b"figi", "instrument_uid", b"instrument_uid", "stream_id", b"stream_id", "subscription_action", b"subscription_action", "subscription_id", b"subscription_id", "subscription_status", b"subscription_status", "ticker", b"ticker", "with_open_interest", b"with_open_interest"]) -> None: ...
...
class InfoSubscription(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "figi", b"figi", "instrument_uid", b"instrument_uid", "stream_id", b"stream_id", "subscription_action", b"subscription_action", "subscription_id", b"subscription_id", "subscription_status", b"subscription_status", "ticker", b"ticker"]) -> None: ...
...
class Candle(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["candle_source_type", b"candle_source_type", "class_code", b"class_code", "close", b"close", "figi", b"figi", "high", b"high", "instrument_uid", b"instrument_uid", "interval", b"interval", "last_trade_ts", b"last_trade_ts", "low", b"low", "open", b"open", "ticker", b"ticker", "time", b"time", "volume", b"volume", "volume_buy", b"volume_buy", "volume_sell", b"volume_sell"]) -> None: ...
...
class OrderBook(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["asks", b"asks", "bids", b"bids", "class_code", b"class_code", "depth", b"depth", "figi", b"figi", "instrument_uid", b"instrument_uid", "is_consistent", b"is_consistent", "limit_down", b"limit_down", "limit_up", b"limit_up", "order_book_type", b"order_book_type", "ticker", b"ticker", "time", b"time"]) -> None: ...
...
class Trade(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "direction", b"direction", "figi", b"figi", "instrument_uid", b"instrument_uid", "price", b"price", "quantity", b"quantity", "ticker", b"ticker", "time", b"time", "trade_source", b"trade_source"]) -> None: ...
...
class TradingStatus(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "figi", b"figi", "instrument_uid", b"instrument_uid", "limit_order_available_flag", b"limit_order_available_flag", "market_order_available_flag", b"market_order_available_flag", "ticker", b"ticker", "time", b"time", "trading_status", b"trading_status"]) -> None: ...
...
class HistoricCandle(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["candle_source", b"candle_source", "close", b"close", "high", b"high", "is_complete", b"is_complete", "low", b"low", "open", b"open", "time", b"time", "volume", b"volume", "volume_buy", b"volume_buy", "volume_sell", b"volume_sell"]) -> None: ...
...
class GetLastPricesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_instrument_status", b"_instrument_status", "figi", b"figi", "instrument_id", b"instrument_id", "instrument_status", b"instrument_status", "last_price_type", b"last_price_type"]) -> None: ...
...
class LastPrice(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["price", b"price", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "figi", b"figi", "instrument_uid", b"instrument_uid", "last_price_type", b"last_price_type", "price", b"price", "ticker", b"ticker", "time", b"time"]) -> None: ...
...
class OpenInterest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "instrument_uid", b"instrument_uid", "open_interest", b"open_interest", "ticker", b"ticker", "time", b"time"]) -> None: ...
...
class GetTradingStatusResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["api_trade_available_flag", b"api_trade_available_flag", "bestprice_order_available_flag", b"bestprice_order_available_flag", "class_code", b"class_code", "figi", b"figi", "instrument_uid", b"instrument_uid", "limit_order_available_flag", b"limit_order_available_flag", "market_order_available_flag", b"market_order_available_flag", "only_best_price", b"only_best_price", "ticker", b"ticker", "trading_status", b"trading_status"]) -> None: ...
...
class GetLastTradesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_figi", b"_figi", "_instrument_id", b"_instrument_id", "figi", b"figi", "from", b"from", "instrument_id", b"instrument_id", "to", b"to", "trade_source", b"trade_source"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_figi", b"_figi"]) -> typing_extensions.Literal["figi"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_instrument_id", b"_instrument_id"]) -> typing_extensions.Literal["instrument_id"] | None: ...
...
class GetClosePricesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_instrument_status", b"_instrument_status", "instrument_status", b"instrument_status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_instrument_status", b"_instrument_status", "instrument_status", b"instrument_status", "instruments", b"instruments"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_instrument_status", b"_instrument_status"]) -> typing_extensions.Literal["instrument_status"] | None: ...
...
class InstrumentClosePriceResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["evening_session_price", b"evening_session_price", "evening_session_price_time", b"evening_session_price_time", "price", b"price", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "evening_session_price", b"evening_session_price", "evening_session_price_time", b"evening_session_price_time", "figi", b"figi", "instrument_uid", b"instrument_uid", "price", b"price", "ticker", b"ticker", "time", b"time"]) -> None: ...
...
class GetMarketValuesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["instrument_id", b"instrument_id", "values", b"values"]) -> None: ...
...
class MarketValueInstrument(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["class_code", b"class_code", "instrument_uid", b"instrument_uid", "ticker", b"ticker", "values", b"values"]) -> None: ...
...
class MarketValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_time", b"_time", "_type", b"_type", "_value", b"_value", "time", b"time", "type", b"type", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_time", b"_time", "_type", b"_type", "_value", b"_value", "time", b"time", "type", b"type", "value", b"value"]) -> None: ...
    @typing.overload
