...
recommend_to_short_regexp = re.compile(r".*(арест|банкротств| суд([^оя]|$)| иск([^лу]|$)|изъят|сизо|упк рф|долг([^о]|$)|погиб|убит|умер([^е]|$)|уничтожен|взорван|разрушен|допк|эмиссия).*")
