...
def _create_combined_positive_yield_chartsheet(workbook, stats):
    ...
    chart.add_series(
        {
            "categories": f"='Combined positive yield (Data)'!A1:J1",
            "values": f"='Combined positive yield (Data)'!A2:J2",
            "data_labels": {
                "value": True,
            },
        }
...
def _create_combined_negative_yield_chartsheet(workbook, stats):
    ...
    chart.add_series(
        {
            "categories": f"='Combined negative yield (Data)'!A1:J1",
            "values": f"='Combined negative yield (Data)'!A2:J2",
            "data_labels": {
                "value": True,
            },
        }
