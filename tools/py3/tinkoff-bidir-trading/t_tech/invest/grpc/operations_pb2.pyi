...
class _OperationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_OperationType.ValueType], builtins.type):
    ...
    OPERATION_TYPE_FUNDING: _OperationType.ValueType  # 70
    """Списание фандинга."""
...
""" отмена заявки на первичное размещение по ЦФА;"""
OPERATION_TYPE_FUNDING: OperationType.ValueType  # 70
"""Списание фандинга."""
...
class PortfolioResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["daily_yield", b"daily_yield", "daily_yield_relative", b"daily_yield_relative", "expected_yield", b"expected_yield", "total_amount_bonds", b"total_amount_bonds", "total_amount_currencies", b"total_amount_currencies", "total_amount_dfa", b"total_amount_dfa", "total_amount_etf", b"total_amount_etf", "total_amount_futures", b"total_amount_futures", "total_amount_options", b"total_amount_options", "total_amount_portfolio", b"total_amount_portfolio", "total_amount_shares", b"total_amount_shares", "total_amount_sp", b"total_amount_sp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "daily_yield", b"daily_yield", "daily_yield_relative", b"daily_yield_relative", "expected_yield", b"expected_yield", "positions", b"positions", "total_amount_bonds", b"total_amount_bonds", "total_amount_currencies", b"total_amount_currencies", "total_amount_dfa", b"total_amount_dfa", "total_amount_etf", b"total_amount_etf", "total_amount_futures", b"total_amount_futures", "total_amount_options", b"total_amount_options", "total_amount_portfolio", b"total_amount_portfolio", "total_amount_shares", b"total_amount_shares", "total_amount_sp", b"total_amount_sp", "virtual_positions", b"virtual_positions"]) -> None: ...
...
class PositionsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "blocked", b"blocked", "futures", b"futures", "limits_loading_in_progress", b"limits_loading_in_progress", "money", b"money", "options", b"options", "securities", b"securities"]) -> None: ...
...
class PortfolioPosition(google.protobuf.message.Message):
    ...
    VAR_MARGIN_SETTLED_FIELD_NUMBER: builtins.int
    figi: builtins.str
    ...
    @property
    def var_margin_settled(self) -> t_tech.invest.grpc.common_pb2.MoneyValue:
    ...
    def __init__(
        ...
        *,
        ...
        ticker: builtins.str = ...,
        class_code: builtins.str = ...,
        var_margin_settled: t_tech.invest.grpc.common_pb2.MoneyValue | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_var_margin_settled", b"_var_margin_settled", "average_position_price", b"average_position_price", "average_position_price_fifo", b"average_position_price_fifo", "average_position_price_pt", b"average_position_price_pt", "blocked_lots", b"blocked_lots", "current_nkd", b"current_nkd", "current_price", b"current_price", "daily_yield", b"daily_yield", "expected_yield", b"expected_yield", "expected_yield_fifo", b"expected_yield_fifo", "quantity", b"quantity", "quantity_lots", b"quantity_lots", "var_margin", b"var_margin", "var_margin_settled", b"var_margin_settled"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_var_margin_settled", b"_var_margin_settled", "average_position_price", b"average_position_price", "average_position_price_fifo", b"average_position_price_fifo", "average_position_price_pt", b"average_position_price_pt", "blocked", b"blocked", "blocked_lots", b"blocked_lots", "class_code", b"class_code", "current_nkd", b"current_nkd", "current_price", b"current_price", "daily_yield", b"daily_yield", "expected_yield", b"expected_yield", "expected_yield_fifo", b"expected_yield_fifo", "figi", b"figi", "instrument_type", b"instrument_type", "instrument_uid", b"instrument_uid", "position_uid", b"position_uid", "quantity", b"quantity", "quantity_lots", b"quantity_lots", "ticker", b"ticker", "var_margin", b"var_margin", "var_margin_settled", b"var_margin_settled"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_var_margin_settled", b"_var_margin_settled"]) -> typing_extensions.Literal["var_margin_settled"] | None: ...
...
class PositionsSecurities(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["balance", b"balance", "blocked", b"blocked", "class_code", b"class_code", "exchange_blocked", b"exchange_blocked", "figi", b"figi", "instrument_type", b"instrument_type", "instrument_uid", b"instrument_uid", "position_uid", b"position_uid", "ticker", b"ticker"]) -> None: ...
...
class PositionsFutures(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["balance", b"balance", "blocked", b"blocked", "class_code", b"class_code", "figi", b"figi", "instrument_uid", b"instrument_uid", "position_uid", b"position_uid", "ticker", b"ticker"]) -> None: ...
...
class PositionsOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["balance", b"balance", "blocked", b"blocked", "class_code", b"class_code", "instrument_uid", b"instrument_uid", "position_uid", b"position_uid", "ticker", b"ticker"]) -> None: ...
...
class GetBrokerReportResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["broker_report", b"broker_report", "itemsCount", b"itemsCount", "page", b"page", "pagesCount", b"pagesCount", "task_id", b"task_id"]) -> None: ...
...
class PortfolioStreamRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ping_settings", b"ping_settings"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["accounts", b"accounts", "ping_settings", b"ping_settings"]) -> None: ...
...
class PositionsStreamRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ping_settings", b"ping_settings"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["accounts", b"accounts", "ping_settings", b"ping_settings", "with_initial_positions", b"with_initial_positions"]) -> None: ...
...
class PositionsStreamResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["initial_positions", b"initial_positions", "payload", b"payload", "ping", b"ping", "position", b"position", "subscriptions", b"subscriptions"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["initial_positions", b"initial_positions", "payload", b"payload", "ping", b"ping", "position", b"position", "subscriptions", b"subscriptions"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["payload", b"payload"]) -> typing_extensions.Literal["subscriptions", "position", "ping", "initial_positions"] | None: ...
...
class OperationsStreamResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["operation", b"operation", "payload", b"payload", "ping", b"ping", "subscriptions", b"subscriptions"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["operation", b"operation", "payload", b"payload", "ping", b"ping", "subscriptions", b"subscriptions"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["payload", b"payload"]) -> typing_extensions.Literal["subscriptions", "operation", "ping"] | None: ...
...
class OperationsSubscriptionResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accounts", b"accounts", "stream_id", b"stream_id", "subscription_status", b"subscription_status", "tracking_id", b"tracking_id"]) -> None: ...
...
class OperationData(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["date", b"date", "payment", b"payment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["broker_account_id", b"broker_account_id", "class_code", b"class_code", "date", b"date", "figi", b"figi", "id", b"id", "instrument_kind", b"instrument_kind", "instrument_type", b"instrument_type", "instrument_uid", b"instrument_uid", "name", b"name", "parent_operation_id", b"parent_operation_id", "payment", b"payment", "position_uid", b"position_uid", "state", b"state", "ticker", b"ticker", "type", b"type"]) -> None: ...
