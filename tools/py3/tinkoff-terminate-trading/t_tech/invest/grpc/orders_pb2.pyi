...
import t_tech.invest.grpc.stoporders_pb2
import typing
...
class TradesStreamRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_ping_delay_ms", b"_ping_delay_ms", "ping_delay_ms", b"ping_delay_ms"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_ping_delay_ms", b"_ping_delay_ms", "accounts", b"accounts", "ping_delay_ms", b"ping_delay_ms"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_ping_delay_ms", b"_ping_delay_ms"]) -> typing_extensions.Literal["ping_delay_ms"] | None: ...
...
class GetOrdersRequest(google.protobuf.message.Message):
    ...
    class GetOrdersRequestFilters(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["_from", b"_from", "_to", b"_to", "execution_status", b"execution_status", "from", b"from", "to", b"to"]) -> None: ...
        @typing.overload
    ...
    def HasField(self, field_name: typing_extensions.Literal["_advanced_filters", b"_advanced_filters", "advanced_filters", b"advanced_filters"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_advanced_filters", b"_advanced_filters", "account_id", b"account_id", "advanced_filters", b"advanced_filters"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_advanced_filters", b"_advanced_filters"]) -> typing_extensions.Literal["advanced_filters"] | None: ...
...
class ReplaceOrderRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_order_id_type", b"_order_id_type", "_price", b"_price", "_price_type", b"_price_type", "order_id_type", b"order_id_type", "price", b"price", "price_type", b"price_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_order_id_type", b"_order_id_type", "_price", b"_price", "_price_type", b"_price_type", "account_id", b"account_id", "confirm_margin_trade", b"confirm_margin_trade", "idempotency_key", b"idempotency_key", "order_id", b"order_id", "order_id_type", b"order_id_type", "price", b"price", "price_type", b"price_type", "quantity", b"quantity"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_order_id_type", b"_order_id_type"]) -> typing_extensions.Literal["order_id_type"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_price", b"_price"]) -> typing_extensions.Literal["price"] | None: ...
...
class OrderStateStreamResponse(google.protobuf.message.Message):
    ...
    @typing_extensions.final
    class StopOrderState(google.protobuf.message.Message):
        """Стоп-ордер"""
        ...
        class_code: builtins.str
        """Класс-код."""
        status: t_tech.invest.grpc.stoporders_pb2.StopOrderStatusOption.ValueType
        """Состояние заявки."""
        def __init__(
            self,
            *,
        ...
        def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "price", b"price", "stop_price", b"stop_price"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "class_code", b"class_code", "created_at", b"created_at", "direction", b"direction", "instrument_uid", b"instrument_uid", "order_type", b"order_type", "price", b"price", "status", b"status", "stop_order_id", b"stop_order_id", "stop_price", b"stop_price", "ticker", b"ticker"]) -> None: ...

    ORDER_STATE_FIELD_NUMBER: builtins.int
    PING_FIELD_NUMBER: builtins.int
    SUBSCRIPTION_FIELD_NUMBER: builtins.int
    STOP_ORDER_STATE_FIELD_NUMBER: builtins.int
    @property
    ...
    def subscription(self) -> global___SubscriptionResponse:
        """Ответ на запрос на подписку."""
    @property
    def stop_order_state(self) -> global___OrderStateStreamResponse.StopOrderState:
        """Стоп-ордер."""
    def __init__(
        self,
        *,
        ...
        ping: t_tech.invest.grpc.common_pb2.Ping | None = ...,
        subscription: global___SubscriptionResponse | None = ...,
        stop_order_state: global___OrderStateStreamResponse.StopOrderState | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["order_state", b"order_state", "payload", b"payload", "ping", b"ping", "stop_order_state", b"stop_order_state", "subscription", b"subscription"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["order_state", b"order_state", "payload", b"payload", "ping", b"ping", "stop_order_state", b"stop_order_state", "subscription", b"subscription"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["payload", b"payload"]) -> typing_extensions.Literal["order_state", "ping", "subscription", "stop_order_state"] | None: ...
