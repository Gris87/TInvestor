...
#ifdef Q_OS_WINDOWS
const char* const AUTORUN_PATH = "CurrentVersion/Run/TInvestorNotifier";
#endif
...
void AutorunEnabler::enable()
{
    ...
    const std::shared_ptr<IFile> file =
        mFileFactory->newInstance(QDir::homePath() + "/.config/autostart/TInvestorNotifier.desktop");
