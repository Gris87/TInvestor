...
class Test_SellDecision4Config : public ::testing::Test
{
protected:
    void SetUp() override
    {
        config = new SellDecision4Config();
    }
...
TEST_F(Test_SellDecision4Config, Test_constructor_and_destructor)
{
}

TEST_F(Test_SellDecision4Config, Test_clone_and_deleteRecursively)
{
...
TEST_F(Test_SellDecision4Config, Test_assign)
{
...
TEST_F(Test_SellDecision4Config, Test_isDefault)
{
    config->makeDefault(4);
...
TEST_F(Test_SellDecision4Config, Test_save)
{
...
TEST_F(Test_SellDecision4Config, Test_load)
{
    const InSequence seq;
...
TEST_F(Test_SellDecision4Config, Test_fromJsonObject)
{
...
TEST_F(Test_SellDecision4Config, Test_toJsonString)
{
    config->setEnabled(true);
...
TEST_F(Test_SellDecision4Config, Test_variantsAsJson)
{
...
TEST_F(Test_SellDecision4Config, Test_setDuration_and_getDuration)
{
    config->setDuration(1);
    ASSERT_EQ(config->getDuration(), 1);
...
TEST_F(Test_SellDecision4Config, Test_setYieldAbove_and_getYieldAbove)
{
