...
TEST(Test_SellDecision3Config, Test_variantsAsJson)
{
    ...
    ASSERT_EQ(variants.at(1), R"({"enabled":true,"loseYield":"3.00","duration":5})");
    ASSERT_EQ(variants.at(2), R"({"enabled":true,"loseYield":"3.00","duration":15})");
    ASSERT_EQ(variants.at(3), R"({"enabled":true,"loseYield":"3.00","duration":30})");
    ASSERT_EQ(variants.at(4), R"({"enabled":true,"loseYield":"4.00","duration":5})");
    ASSERT_EQ(variants.at(5), R"({"enabled":true,"loseYield":"4.00","duration":15})");
    ASSERT_EQ(variants.at(6), R"({"enabled":true,"loseYield":"4.00","duration":30})");
    ASSERT_EQ(variants.at(7), R"({"enabled":true,"loseYield":"5.00","duration":5})");
    ASSERT_EQ(variants.at(8), R"({"enabled":true,"loseYield":"5.00","duration":15})");
    ASSERT_EQ(variants.at(9), R"({"enabled":true,"loseYield":"5.00","duration":30})");
}
