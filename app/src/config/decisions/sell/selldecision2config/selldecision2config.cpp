...
constexpr float YIELD_ABOVE_DEFAULT_30 = 1.0f;
constexpr float LOSE_YIELD_DEFAULT_30  = 0.1f;

// For commission 0.05%
constexpr bool  ENABLED_DEFAULT_5     = false;
constexpr float YIELD_ABOVE_DEFAULT_5 = 1.0f;
constexpr float LOSE_YIELD_DEFAULT_5  = 0.1f;

// For commission 0.04%
constexpr bool  ENABLED_DEFAULT_4     = false;
constexpr float YIELD_ABOVE_DEFAULT_4 = 1.0f;
constexpr float LOSE_YIELD_DEFAULT_4  = 0.1f;
...
void SellDecision2Config::makeDefault(int commissionInt)
{
    const QWriteLocker lock(mRwMutex);
...
bool SellDecision2Config::isDefault(int commissionInt)
{
    SellDecision2Config defaultConfig;
    ...
    return mEnabled == defaultConfig.mEnabled && mYieldAbove == defaultConfig.mYieldAbove &&
           mLoseYield == defaultConfig.mLoseYield;
}
