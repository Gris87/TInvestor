...
class Test_BuyDecision1Config : public ::testing::Test
{
protected:
    void SetUp() override
    {
        config = new BuyDecision1Config();
    }
...
TEST_F(Test_BuyDecision1Config, Test_constructor_and_destructor)
{
}

TEST_F(Test_BuyDecision1Config, Test_clone_and_deleteRecursively)
{
...
TEST_F(Test_BuyDecision1Config, Test_assign)
{
...
TEST_F(Test_BuyDecision1Config, Test_makeDefault)
{
    config->setEnabled(false);
    config->setPriceFall(22.5f);
    config->setDuration(123);

    // clang-format off
    ASSERT_EQ(config->isEnabled(),    false);
    ASSERT_EQ(config->getPriceFall(), 22.5f);
    ASSERT_EQ(config->getDuration(),  123);
    // clang-format on
...
TEST_F(Test_BuyDecision1Config, Test_isDefault)
{
    config->makeDefault(4);
...
TEST_F(Test_BuyDecision1Config, Test_save)
{
...
TEST_F(Test_BuyDecision1Config, Test_load)
{
    const InSequence seq;
...
TEST_F(Test_BuyDecision1Config, Test_fromJsonObject)
{
...
TEST_F(Test_BuyDecision1Config, Test_toJsonString)
{
    config->setEnabled(true);
...
TEST_F(Test_BuyDecision1Config, Test_variantsAsJson)
{
    QStringList variants = config->variantsAsJson();

    ASSERT_EQ(variants.size(), 17);
    ASSERT_EQ(variants.at(0), R"({"enabled":false})");
    ASSERT_EQ(variants.at(1), R"({"enabled":true,"priceFall":"3.50","duration":5})");
    ASSERT_EQ(variants.at(2), R"({"enabled":true,"priceFall":"3.50","duration":15})");
    ASSERT_EQ(variants.at(3), R"({"enabled":true,"priceFall":"3.50","duration":30})");
    ASSERT_EQ(variants.at(4), R"({"enabled":true,"priceFall":"3.50","duration":60})");
    ASSERT_EQ(variants.at(5), R"({"enabled":true,"priceFall":"4.00","duration":5})");
    ASSERT_EQ(variants.at(6), R"({"enabled":true,"priceFall":"4.00","duration":15})");
    ASSERT_EQ(variants.at(7), R"({"enabled":true,"priceFall":"4.00","duration":30})");
    ASSERT_EQ(variants.at(8), R"({"enabled":true,"priceFall":"4.00","duration":60})");
    ASSERT_EQ(variants.at(9), R"({"enabled":true,"priceFall":"4.50","duration":5})");
    ASSERT_EQ(variants.at(10), R"({"enabled":true,"priceFall":"4.50","duration":15})");
    ASSERT_EQ(variants.at(11), R"({"enabled":true,"priceFall":"4.50","duration":30})");
    ASSERT_EQ(variants.at(12), R"({"enabled":true,"priceFall":"4.50","duration":60})");
    ASSERT_EQ(variants.at(13), R"({"enabled":true,"priceFall":"5.00","duration":5})");
    ASSERT_EQ(variants.at(14), R"({"enabled":true,"priceFall":"5.00","duration":15})");
    ASSERT_EQ(variants.at(15), R"({"enabled":true,"priceFall":"5.00","duration":30})");
    ASSERT_EQ(variants.at(16), R"({"enabled":true,"priceFall":"5.00","duration":60})");
}

TEST_F(Test_BuyDecision1Config, Test_setEnabled_and_isEnabled)
{
    config->setEnabled(false);
    ASSERT_EQ(config->isEnabled(), false);
...
TEST_F(Test_BuyDecision1Config, Test_setPriceFall_and_getPriceFall)
{
...
TEST_F(Test_BuyDecision1Config, Test_setDuration_and_getDuration)
{
