...
TEST(Test_BuyDecision1Config, Test_variantsAsJson)
{
    ...
    ASSERT_EQ(variants.at(5), R"({"enabled":true,"priceFall":"3.00","duration":5})");
    ASSERT_EQ(variants.at(6), R"({"enabled":true,"priceFall":"3.00","duration":15})");
    ASSERT_EQ(variants.at(7), R"({"enabled":true,"priceFall":"3.00","duration":30})");
    ASSERT_EQ(variants.at(8), R"({"enabled":true,"priceFall":"3.00","duration":60})");
    ASSERT_EQ(variants.at(9), R"({"enabled":true,"priceFall":"4.00","duration":5})");
    ASSERT_EQ(variants.at(10), R"({"enabled":true,"priceFall":"4.00","duration":15})");
    ASSERT_EQ(variants.at(11), R"({"enabled":true,"priceFall":"4.00","duration":30})");
    ASSERT_EQ(variants.at(12), R"({"enabled":true,"priceFall":"4.00","duration":60})");
