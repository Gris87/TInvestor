...
class IBuyDecision6Config
{
public:
    IBuyDecision6Config()          = default;
    virtual ~IBuyDecision6Config() = default;

    IBuyDecision6Config(const IBuyDecision6Config& another)            = delete;
    IBuyDecision6Config& operator=(const IBuyDecision6Config& another) = delete;
    ...
    virtual bool                 isDefault(int commissionInt)         = 0;
