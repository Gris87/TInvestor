...
void BuyDecision6ConfigWidget::on_priceRaiseDoubleSpinBox_valueChanged(double value)
{
    mConfig->setPriceRaise(value);
}

void BuyDecision6ConfigWidget::on_orderBookPositionsSpinBox_valueChanged(int value)
{
