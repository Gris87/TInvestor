...
{
public:
    BuyDecision2ConfigWidgetFactoryMock() : IBuyDecision2ConfigWidgetFactory() {}
    ...
    MOCK_METHOD2(newInstance, IBuyDecision2ConfigWidget*(IBuyDecision2Config *config, QWidget *parent));
};
