...
TEST(Test_BuyDecision2Config, Test_variantsAsJson)
{
    ...
    ASSERT_EQ(variants.at(1), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.3","duration":5})");
    ASSERT_EQ(variants.at(2), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.3","duration":15})");
    ASSERT_EQ(variants.at(3), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.3","duration":30})");
    ASSERT_EQ(variants.at(4), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.5","duration":5})");
    ASSERT_EQ(variants.at(5), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.5","duration":15})");
    ASSERT_EQ(variants.at(6), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.5","duration":30})");
    ASSERT_EQ(variants.at(7), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.7","duration":5})");
    ASSERT_EQ(variants.at(8), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.7","duration":15})");
    ASSERT_EQ(variants.at(9), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.7","duration":30})");
    ASSERT_EQ(variants.at(10), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.3","duration":5})");
    ASSERT_EQ(variants.at(11), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.3","duration":15})");
    ASSERT_EQ(variants.at(12), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.3","duration":30})");
    ASSERT_EQ(variants.at(13), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.5","duration":5})");
    ASSERT_EQ(variants.at(14), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.5","duration":15})");
    ASSERT_EQ(variants.at(15), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.5","duration":30})");
    ASSERT_EQ(variants.at(16), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.7","duration":5})");
    ASSERT_EQ(variants.at(17), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.7","duration":15})");
    ASSERT_EQ(variants.at(18), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.7","duration":30})");
    ASSERT_EQ(variants.at(19), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.3","duration":5})");
    ASSERT_EQ(variants.at(20), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.3","duration":15})");
    ASSERT_EQ(variants.at(21), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.3","duration":30})");
    ASSERT_EQ(variants.at(22), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.5","duration":5})");
    ASSERT_EQ(variants.at(23), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.5","duration":15})");
    ASSERT_EQ(variants.at(24), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.5","duration":30})");
    ASSERT_EQ(variants.at(25), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.7","duration":5})");
    ASSERT_EQ(variants.at(26), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.7","duration":15})");
