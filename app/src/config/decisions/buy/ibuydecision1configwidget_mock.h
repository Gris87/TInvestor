...
{
public:
    BuyDecision1ConfigWidgetMock(QWidget *parent = nullptr) : IBuyDecision1ConfigWidget(parent) {}
    ...
    MOCK_METHOD1(setBuyDecision1Config, void(IBuyDecision1Config *config));
