...
TEST_F(Test_BuyDecision7ConfigWidget, Test_updateUiFromConfig)
{
    ...
    EXPECT_CALL(*buyDecision7ConfigMock, getOrderBookPositions()).WillOnce(Return(3));
    ...
    EXPECT_CALL(*buyDecision7ConfigMock, getOrderBookPositions()).WillOnce(Return(6));
...
TEST_F(Test_BuyDecision7ConfigWidget, Test_on_orderBookPositionsSpinBox_valueChanged)
{
    const InSequence seq;
    ...
    EXPECT_CALL(*buyDecision7ConfigMock, setOrderBookPositions(2));
    configWidget->ui->orderBookPositionsSpinBox->setValue(2);

    EXPECT_CALL(*buyDecision7ConfigMock, setOrderBookPositions(3));
