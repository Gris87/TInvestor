...
TEST(Test_BuyDecision4Config, Test_variantsAsJson)
{
    ...
    ASSERT_EQ(variants.at(1), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.1","duration":5})");
    ASSERT_EQ(variants.at(2), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.1","duration":15})");
    ASSERT_EQ(variants.at(3), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.1","duration":30})");
    ASSERT_EQ(variants.at(4), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.3","duration":5})");
    ASSERT_EQ(variants.at(5), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.3","duration":15})");
    ASSERT_EQ(variants.at(6), R"({"enabled":true,"priceFall":"3.00","loseYield":"0.3","duration":30})");
    ...
    ASSERT_EQ(variants.at(10), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.1","duration":5})");
    ASSERT_EQ(variants.at(11), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.1","duration":15})");
    ASSERT_EQ(variants.at(12), R"({"enabled":true,"priceFall":"4.00","loseYield":"0.1","duration":30})");
    ...
    ASSERT_EQ(variants.at(19), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.1","duration":5})");
    ASSERT_EQ(variants.at(20), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.1","duration":15})");
    ASSERT_EQ(variants.at(21), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.1","duration":30})");
    ASSERT_EQ(variants.at(22), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.3","duration":5})");
    ASSERT_EQ(variants.at(23), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.3","duration":15})");
    ASSERT_EQ(variants.at(24), R"({"enabled":true,"priceFall":"5.00","loseYield":"0.3","duration":30})");
