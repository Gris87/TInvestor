...
TEST(Test_BuyDecision4Config, Test_variantsAsJson)
{
    ...
    ASSERT_EQ(variants.at(4), R"({"enabled":true,"priceFall":"10.00","loseYield":"2.0","duration":3})");
    ASSERT_EQ(variants.at(5), R"({"enabled":true,"priceFall":"10.00","loseYield":"2.0","duration":7})");
    ASSERT_EQ(variants.at(6), R"({"enabled":true,"priceFall":"10.00","loseYield":"2.0","duration":14})");
    ASSERT_EQ(variants.at(7), R"({"enabled":true,"priceFall":"10.00","loseYield":"3.0","duration":3})");
    ASSERT_EQ(variants.at(8), R"({"enabled":true,"priceFall":"10.00","loseYield":"3.0","duration":7})");
    ASSERT_EQ(variants.at(9), R"({"enabled":true,"priceFall":"10.00","loseYield":"3.0","duration":14})");
    ASSERT_EQ(variants.at(10), R"({"enabled":true,"priceFall":"15.00","loseYield":"1.0","duration":3})");
    ASSERT_EQ(variants.at(11), R"({"enabled":true,"priceFall":"15.00","loseYield":"1.0","duration":7})");
    ASSERT_EQ(variants.at(12), R"({"enabled":true,"priceFall":"15.00","loseYield":"1.0","duration":14})");
    ASSERT_EQ(variants.at(13), R"({"enabled":true,"priceFall":"15.00","loseYield":"2.0","duration":3})");
    ASSERT_EQ(variants.at(14), R"({"enabled":true,"priceFall":"15.00","loseYield":"2.0","duration":7})");
    ASSERT_EQ(variants.at(15), R"({"enabled":true,"priceFall":"15.00","loseYield":"2.0","duration":14})");
    ASSERT_EQ(variants.at(16), R"({"enabled":true,"priceFall":"15.00","loseYield":"3.0","duration":3})");
    ASSERT_EQ(variants.at(17), R"({"enabled":true,"priceFall":"15.00","loseYield":"3.0","duration":7})");
    ASSERT_EQ(variants.at(18), R"({"enabled":true,"priceFall":"15.00","loseYield":"3.0","duration":14})");
    ASSERT_EQ(variants.at(19), R"({"enabled":true,"priceFall":"20.00","loseYield":"1.0","duration":3})");
    ASSERT_EQ(variants.at(20), R"({"enabled":true,"priceFall":"20.00","loseYield":"1.0","duration":7})");
    ASSERT_EQ(variants.at(21), R"({"enabled":true,"priceFall":"20.00","loseYield":"1.0","duration":14})");
    ASSERT_EQ(variants.at(22), R"({"enabled":true,"priceFall":"20.00","loseYield":"2.0","duration":3})");
    ASSERT_EQ(variants.at(23), R"({"enabled":true,"priceFall":"20.00","loseYield":"2.0","duration":7})");
    ASSERT_EQ(variants.at(24), R"({"enabled":true,"priceFall":"20.00","loseYield":"2.0","duration":14})");
    ASSERT_EQ(variants.at(25), R"({"enabled":true,"priceFall":"20.00","loseYield":"3.0","duration":3})");
    ASSERT_EQ(variants.at(26), R"({"enabled":true,"priceFall":"20.00","loseYield":"3.0","duration":7})");
    ASSERT_EQ(variants.at(27), R"({"enabled":true,"priceFall":"20.00","loseYield":"3.0","duration":14})");
}
