...
constexpr float HUGE_BID_DEFAULT                                    = 1.2f;
constexpr bool  HUGE_BID_LIMIT_STOCK_PURCHASE_DEFAULT               = true;
constexpr float HUGE_BID_LIMIT_STOCK_PURCHASE_PART_DEFAULT          = 5.0f;
constexpr bool  HUGE_BID_LIMIT_BY_TURNOVER_DEFAULT                  = true;
constexpr float HUGE_BID_LIMIT_BY_TURNOVER_PERCENT_DEFAULT          = 5.0f;
constexpr bool  TRADE_HUGE_SPREAD_DEFAULT                           = true;
constexpr float HUGE_SPREAD_DEFAULT                                 = 0.5f;
constexpr bool  HUGE_SPREAD_LIMIT_STOCK_PURCHASE_DEFAULT            = true;
constexpr float HUGE_SPREAD_LIMIT_STOCK_PURCHASE_PART_DEFAULT       = 5.0f;
constexpr bool  HUGE_SPREAD_LIMIT_BY_TURNOVER_DEFAULT               = true;
constexpr float HUGE_SPREAD_LIMIT_BY_TURNOVER_PERCENT_DEFAULT       = 5.0f;
constexpr bool  TRADE_LIQUIDITY_ETF_NIGHTLY_DEFAULT                 = true;
constexpr float LIQUIDITY_ETF_REMAINED_PART_NIGHTLY_DEFAULT         = 0.0f;
constexpr bool  LIMIT_STOCK_PURCHASE_DEFAULT                        = true;
constexpr float LIMIT_STOCK_PURCHASE_PART_DEFAULT                   = 5.0f;
constexpr bool  LIMIT_BY_TURNOVER_DEFAULT                           = true;
constexpr float LIMIT_BY_TURNOVER_PERCENT_DEFAULT                   = 5.0f;
constexpr bool  LIMIT_STOCK_PURCHASE_NON_WORKING_HOURS_DEFAULT      = false;
...
constexpr float ADDITIONAL_GAP_PERCENT_DEFAULT                      = 1.0f;
