...
TEST_F(Test_DecisionMaker, Test_makeDecision)
{
    ...
    EXPECT_CALL(
        *sellDecisionMock,
        makeDecision(
            QThread::currentThread(), simulatorConfigMock, &stock2, false, -1, FloatEq(0.2f), FloatEq(203.0f), FloatEq(0.04f)
        )
    )
        .WillOnce(Return("I want to sell"));

    InstrumentsForTrading result = decisionMaker->makeDecision(1704110400000, configMock, portfolio, stocks, false, 0, false);
    ...
    result = decisionMaker->makeDecision(1704056400000, configMock, portfolio, stocks, false, 0, false);
    ...
    EXPECT_CALL(
        *sellDecisionMock,
        makeDecision(
            QThread::currentThread(), autoPilotConfigMock, &stock1, false, -1, FloatEq(0.1f), FloatEq(103.0f), FloatEq(0.04f)
        )
    )
        .WillOnce(Return(""));
    EXPECT_CALL(
        *sellDecisionMock,
        makeDecision(
            QThread::currentThread(), autoPilotConfigMock, &stock2, false, -1, FloatEq(0.2f), FloatEq(203.0f), FloatEq(0.04f)
        )
    )
        .WillOnce(Return("I want to sell"));

    result = decisionMaker->makeDecision(1704110400000, configMock, portfolio, stocks, false, 0, false);
    ...
    result = decisionMaker->makeDecision(1704110400000, configMock, portfolio, stocks, true, 200000, false);
    ...
    EXPECT_CALL(
        *sellDecisionMock,
        makeDecision(
            QThread::currentThread(), autoPilotConfigMock, &stock2, true, 0, FloatEq(0.2f), FloatEq(203.0f), FloatEq(0.04f)
        )
    )
        .WillOnce(Return("I want to sell"));

    result = decisionMaker->makeDecision(1704110400000, configMock, portfolio, stocks, true, 0, true);
    ...
    result = decisionMaker->makeDecision(1704110460000, configMock, portfolio, stocks, true, 0, true);
