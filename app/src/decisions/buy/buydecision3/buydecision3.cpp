...
// ====================================================================
// Buy stock if price fall more than N % during time period (days)
// ====================================================================
//
// ----------------------------------------------\
//                                               |
...
bool BuyDecision3::doubleCheck(QThread* parentThread, const StockData* stockData, int index, float maximumPrice) const
{
    bool res = true;
