...
TEST_F(Test_BuyDecision6, Test_makeDecision)
{
    ...
    QString cause = buyDecision6->makeDecision(QThread::currentThread(), &configMock, 0, &stock, false, -1, 100.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision6->makeDecision(QThread::currentThread(), &configMock, 0, &stock, true, 1, 100.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision6->makeDecision(QThread::currentThread(), &configMock, 0, &stock, true, 14, 100.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision6->makeDecision(QThread::currentThread(), &configMock, 0, &stock, true, 14, 130.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision6->makeDecision(QThread::currentThread(), &configMock, 0, &stock, false, -1, 100.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision6->makeDecision(QThread::currentThread(), &configMock, 0, &stock, false, -1, 130.0f, -1.0f, 0.04f);
