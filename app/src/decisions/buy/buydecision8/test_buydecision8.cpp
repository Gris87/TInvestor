...
TEST_F(Test_BuyDecision8, Test_makeDecision)
{
    ...
    QString cause =
        buyDecision8->makeDecision(QThread::currentThread(), &configMock, 0, &stock, false, -1, false, 100.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision8->makeDecision(QThread::currentThread(), &configMock, 0, &stock, true, 14, false, 100.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision8->makeDecision(QThread::currentThread(), &configMock, 0, &stock, false, -1, false, 100.0f, -1.0f, 0.04f);
