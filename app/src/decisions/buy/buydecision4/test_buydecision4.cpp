...
TEST_F(Test_BuyDecision4, Test_makeDecision)
{
    ...
    QString cause =
        buyDecision4->makeDecision(QThread::currentThread(), &configMock, 0, &stock, false, -1, false, 100.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision4->makeDecision(
    ...
    cause = buyDecision4->makeDecision(QThread::currentThread(), &configMock, 0, &stock, true, 14, false, 100.0f, -1.0f, 0.04f);
    ...
    cause = buyDecision4->makeDecision(QThread::currentThread(), &configMock, 0, &stock, false, -1, false, 100.0f, -1.0f, 0.04f);
...
TEST_F(Test_BuyDecision4, Test_asapMode)
{
    ASSERT_EQ(buyDecision4->asapMode(), ASAP_MODE_NONE);
}
