...
const char* const VERSION  = "v1.6.0";
...
static int runApplication(QApplication* app)
{
    ...
    BuyDecision5  buyDecision5(&bollindger);
    ...
    SellDecision4 sellDecision4(&bollindger);
    ...
    DetectShortsThread       detectShortsThread(&stocksStorage, &grpcClient);
