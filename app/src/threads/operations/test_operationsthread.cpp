...
TEST_F(Test_OperationsThread, Test_run)
{
    ...
    const std::shared_ptr<tinkoff::OperationsStreamResponse> operationsStreamResponse1(new tinkoff::OperationsStreamResponse());
    const std::shared_ptr<tinkoff::OperationsStreamResponse> operationsStreamResponse2(new tinkoff::OperationsStreamResponse());

    tinkoff::OperationData* operationData1 = new tinkoff::OperationData(); // operationsStreamResponse1 will take ownership
    tinkoff::OperationData* operationData2 = new tinkoff::OperationData(); // operationsStreamResponse2 will take ownership

    operationsStreamResponse1->set_allocated_operation(operationData1);
    operationsStreamResponse2->set_allocated_operation(operationData2);

    EXPECT_CALL(*grpcClientMock, createOperationsStream(QString("account-id"))).WillOnce(Return(operationsStream));
    ...
    EXPECT_CALL(*grpcClientMock, readOperationsStream(operationsStream)).WillOnce(Return(operationsStreamResponse1));
    ...
    EXPECT_CALL(*grpcClientMock, readOperationsStream(operationsStream)).WillOnce(Return(nullptr));
    EXPECT_CALL(*timeUtilsMock, interruptibleSleep(5000, QThread::currentThread())).WillOnce(Return(false));
    EXPECT_CALL(*grpcClientMock, cancelOperationsStream(operationsStream));
    EXPECT_CALL(*grpcClientMock, finishOperationsStream(operationsStream));
    EXPECT_CALL(*grpcClientMock, createOperationsStream(QString("account-id"))).WillOnce(Return(operationsStream));
    EXPECT_CALL(
        *grpcRetryClientMock,
        getValidOperations(QThread::currentThread(), QString("account-id"), 0, Ge(1704056400000), QString(""))
    ...
    EXPECT_CALL(*grpcClientMock, readOperationsStream(operationsStream)).WillOnce(Return(operationsStreamResponse2));
    ...
    EXPECT_CALL(*grpcClientMock, cancelOperationsStream(operationsStream));
    EXPECT_CALL(*grpcClientMock, finishOperationsStream(operationsStream));
    EXPECT_CALL(*grpcClientMock, createOperationsStream(QString("account-id"))).WillOnce(Return(nullptr));
...
TEST_F(Test_OperationsThread, Test_terminateThread)
{
    ...
    ASSERT_EQ(thread->createOperationsStream(), true);
...
TEST_F(Test_OperationsThread, Test_requestOperations)
{
    ...
    QList<Operation> emptyOperations;
    QList<Operation> operations;
    ...
    operation1.costFifo                        = Quotation(2533, 0);
    operation1.costWavg                        = Quotation(2533, 0);
    ...
    operation1.totalMoney                      = Quotation(199999, -266500000);
    ...
    operation2.costFifo                        = Quotation(0, 0);
    operation2.costWavg                        = Quotation(0, 0);
    ...
    operation2.totalMoney                      = Quotation(200000, 0);
    ...
    EXPECT_CALL(*operationsDatabaseMock, writeOperations(emptyOperations, -1));
    EXPECT_CALL(
        *grpcRetryClientMock,
        getValidOperations(QThread::currentThread(), QString("account-id"), 0, Ge(1704056400000), QString(""))
    )
...
TEST_F(Test_OperationsThread, Test_handleOperationItem)
{
    ...
    instrument.minPriceIncrement = Quotation(0, 100000);
    ...
    ASSERT_EQ(operation.totalMoney,                        Quotation(200000, 0));
    ...
    ASSERT_EQ(operation.fifoItems.at(0).cost,              Quotation(2533, 0));
    ...
    ASSERT_EQ(operation.costFifo,                          Quotation(2533, 0));
    ASSERT_EQ(operation.costWavg,                          Quotation(2533, 0));
    ...
    ASSERT_EQ(operation.totalMoney,                        Quotation(199999, -266500000));
    ...
    ASSERT_EQ(operation.fifoItems.at(1).cost,              Quotation(20000, 0));
    ...
    ASSERT_EQ(operation.costFifo,                          Quotation(22533, 0));
    ASSERT_EQ(operation.costWavg,                          Quotation(22533, 0));
    ...
    ASSERT_EQ(operation.totalMoney,                        Quotation(199989, -266500000));
    ASSERT_EQ(operation.pricePrecision,                    4);
    ASSERT_EQ(operation.paymentPrecision,                  2);
    ASSERT_EQ(operation.commissionPrecision,               2);
    // clang-format on
    ...
    ASSERT_EQ(operation.fifoItems.at(2).cost,              Quotation(30000, 0));
    ...
    ASSERT_EQ(operation.costFifo,                          Quotation(52533, 0));
    ASSERT_EQ(operation.costWavg,                          Quotation(52533, 0));
    ...
    ASSERT_EQ(operation.totalMoney,                        Quotation(199974, -266500000));
    ASSERT_EQ(operation.pricePrecision,                    4);
    ASSERT_EQ(operation.paymentPrecision,                  2);
    ASSERT_EQ(operation.commissionPrecision,               2);
    // clang-format on
    ...
    ASSERT_EQ(operation.fifoItems.at(0).cost,              Quotation(10000, 0));
    ASSERT_EQ(operation.fifoItems.at(1).quantity,          200);
    ASSERT_EQ(operation.fifoItems.at(1).cost,              Quotation(30000, 0));
    ...
    ASSERT_EQ(operation.costFifo,                          Quotation(40000, 0));
    ASSERT_EQ(operation.costWavg,                          Quotation(42366, -677419354));
    ...
    ASSERT_EQ(operation.totalMoney,                        Quotation(247411, -266500000));
    ASSERT_EQ(operation.pricePrecision,                    4);
    ASSERT_EQ(operation.paymentPrecision,                  2);
    ASSERT_EQ(operation.commissionPrecision,               2);
    // clang-format on
    ...
    ASSERT_EQ(operation.totalMoney,                        Quotation(282374, -766500000));
    ASSERT_EQ(operation.pricePrecision,                    4);
    ASSERT_EQ(operation.paymentPrecision,                  2);
    ASSERT_EQ(operation.commissionPrecision,               2);
    // clang-format on
    ...
    ASSERT_EQ(operation.fifoItems.at(0).cost,              Quotation(30000, 0));
    ...
    ASSERT_NEAR(operation.payment,                         -30000.0f, 0.0001f);
    ASSERT_NEAR(operation.avgCostFifo,                     30000.0f, 0.0001f);
    ASSERT_EQ(operation.costFifo,                          Quotation(30000, 0));
    ASSERT_EQ(operation.costWavg,                          Quotation(30000, 0));
    ASSERT_NEAR(operation.commission,                      -15.0f, 0.0001f);
    ASSERT_NEAR(operation.yield,                           0.0f, 0.0001f);
    ASSERT_NEAR(operation.yieldWithCommission,             -15.0f, 0.0001f);
    ASSERT_NEAR(operation.yieldWithCommissionPercent,      -0.05f, 0.0001f);
...
TEST_F(Test_OperationsThread, Test_optimize)
{
    ...
    operations.resizeForOverwrite(12);
    optimizedOperations.resizeForOverwrite(5);

    thread->testSetLimitOperations(operations.size() - 2);
    thread->testSetOptimizeSize(optimizedOperations.size() - 2);

    for (int i = 1; i < operations.size() - 1; i += 2)
    {
    ...
    firstOperation.timestamp = ONE_DAY + 1000;
    ...
    QList<Operation> operationsForFirstWrite = operations.mid(1);
    ...
    EXPECT_CALL(*grpcClientMock, createOperationsStream(QString("account-id"))).WillOnce(Return(operationsStream));
    EXPECT_CALL(*operationsDatabaseMock, readOperations(-1)).WillOnce(Return(operations));
    EXPECT_CALL(*operationsDatabaseMock, writeOperations(operationsForFirstWrite, -1));
    EXPECT_CALL(
        *grpcRetryClientMock,
        getValidOperations(QThread::currentThread(), QString("account-id"), 0, Ge(1704056400000), QString(""))
    )
