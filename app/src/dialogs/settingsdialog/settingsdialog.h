...
private slots:
    ...
    void on_tradeLiquidityEtfDailyCheckBox_checkStateChanged(const Qt::CheckState& value);
    void on_liquidityEtfPartDailyDoubleSpinBox_valueChanged(double value);
