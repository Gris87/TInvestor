...
TEST(Test_Operation, Test_copy_constructor)
{
    ...
    operation.totalCost.units                 = 18;
    operation.totalCost.nano                  = 19;
    operation.totalYieldWithCommission.units  = 20;
    operation.totalYieldWithCommission.nano   = 21;
    operation.totalYieldWithCommissionPercent = 22;
    ...
    ASSERT_EQ(operation2.totalCost.units,                   18);
    ASSERT_EQ(operation2.totalCost.nano,                    19);
    ASSERT_EQ(operation2.totalYieldWithCommission.units,    20);
    ASSERT_EQ(operation2.totalYieldWithCommission.nano,     21);
    ASSERT_NEAR(operation2.totalYieldWithCommissionPercent, 22, 0.0001f);
...
TEST(Test_Operation, Test_fromJsonObject)
{
    ...
    const QString content =
        R"({"avgCost":7,"avgPrice":3,"commission":10,"commissionPrecision":24,"cost":{"nano":9,"units":8},"description":"b","instrumentId":"a","payment":6,"paymentPrecision":23,"price":2,"quantity":4,"remainedMoney":{"nano":15,"units":14},"remainedQuantity":5,"timestamp":1,"totalCost":{"nano":19,"units":18},"totalMoney":{"nano":17,"units":16},"totalYieldWithCommission":{"nano":21,"units":20},"totalYieldWithCommissionPercent":22,"yield":11,"yieldWithCommission":12,"yieldWithCommissionPercent":13})";
    ...
    ASSERT_EQ(operation.totalCost.units,                   18);
    ASSERT_EQ(operation.totalCost.nano,                    19);
    ASSERT_EQ(operation.totalYieldWithCommission.units,    20);
    ASSERT_EQ(operation.totalYieldWithCommission.nano,     21);
    ASSERT_NEAR(operation.totalYieldWithCommissionPercent, 22, 0.0001f);
...
TEST(Test_Operation, Test_equals)
{
    ...
    operation2.totalCost.units                 = 18;
    operation2.totalCost.nano                  = 19;
    operation2.totalYieldWithCommission.units  = 20;
    operation2.totalYieldWithCommission.nano   = 21;
    operation2.totalYieldWithCommissionPercent = 22;
    ...
    operation2.totalCost.units = 18888;
    ASSERT_NE(operation, operation2);
    operation2.totalCost.units = 18;
    ASSERT_EQ(operation, operation2);

    operation2.totalCost.nano = 19999;
    ASSERT_NE(operation, operation2);
    operation2.totalCost.nano = 19;
    ASSERT_EQ(operation, operation2);

    operation2.totalYieldWithCommission.units = 20000;
    ASSERT_NE(operation, operation2);
    operation2.totalYieldWithCommission.units = 20;
    ASSERT_EQ(operation, operation2);

    operation2.totalYieldWithCommission.nano = 21111;
    ASSERT_NE(operation, operation2);
    operation2.totalYieldWithCommission.nano = 21;
    ASSERT_EQ(operation, operation2);

    operation2.totalYieldWithCommissionPercent = 22222;
    ASSERT_NE(operation, operation2);
    operation2.totalYieldWithCommissionPercent = 22;
    ASSERT_EQ(operation, operation2);
