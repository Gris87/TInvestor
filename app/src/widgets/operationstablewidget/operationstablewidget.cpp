...
#ifdef Q_OS_WINDOWS
const int COLUMN_WIDTHS[OPERATIONS_COLUMN_COUNT] = {110, 82, 309, 61, 142, 153, 95, 167, 87, 85, 69, 141, 162, 107, 128, 107, 95};
#else
const int COLUMN_WIDTHS[OPERATIONS_COLUMN_COUNT] = {
    121, 80, 309, 62, 152, 160, 102, 180, 95, 90, 73, 148, 170, 114, 136, 117, 101
};
#endif
