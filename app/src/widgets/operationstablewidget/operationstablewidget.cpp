...
#ifdef Q_OS_WINDOWS
const int COLUMN_WIDTHS[OPERATIONS_COLUMN_COUNT] = {110, 82, 309, 61, 142, 153, 95, 167, 87, 85, 78, 141, 162, 107, 128, 107, 95};
#else
const int COLUMN_WIDTHS[OPERATIONS_COLUMN_COUNT] = {
    145, 98, 309, 82, 181, 191, 115, 208, 126, 99, 109, 171, 201, 131, 160, 135, 117
};
#endif
