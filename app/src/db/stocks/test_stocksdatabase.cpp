...
protected:
    ...
    void fillWithData()
    {
        const QString stocksStr =
            ...
            "        \"turnover\":2000,"
            "        \"dividends\":{"
            "            \"createTimestamp\":1735678800000,"
            "            \"paymentTimestamp\":1738357200000,"
            "            \"price\":\"100.0\","
            "            \"yield\":\"10.0\""
            "        },"
            "        \"shorts\":{"
            "            \"enabled\":true,"
            "            \"lastEnabledTimestamp\":1735678800000"
            "        }"
            "    },"
            "    {"
            ...
            "        \"turnover\":5000000,"
            "        \"dividends\":{"
            "            \"createTimestamp\":1738357200000,"
            "            \"paymentTimestamp\":1740776400000,"
            "            \"price\":\"150.0\","
            "            \"yield\":\"15.0\""
            "        },"
            "        \"shorts\":{"
            "            \"enabled\":true,"
            "            \"lastEnabledTimestamp\":1738357200000"
            "        }"
            "    },"
            "    {"
            ...
            "        \"turnover\":9000000000,"
            "        \"dividends\":{"
            "            \"createTimestamp\":1740776400000,"
            "            \"paymentTimestamp\":1743454800000,"
            "            \"price\":\"200.0\","
            "            \"yield\":\"20.0\""
            "        },"
            "        \"shorts\":{"
            "            \"enabled\":true,"
            "            \"lastEnabledTimestamp\":1740776400000"
            "        }"
            "    }"
            "]";
...
TEST_F(Test_StocksDatabase, Test_readStocksMeta)
{
    ...
    ASSERT_EQ(stocks.at(0)->meta.ignore,                      true);
    ...
    ASSERT_EQ(stocks.at(1)->meta.ignore,                      true);
    ...
    ASSERT_EQ(stocks.at(2)->meta.ignore,                      true);
...
TEST_F(Test_StocksDatabase, Test_assignLogos)
{
    const InSequence seq;
    ...
    EXPECT_CALL(*logosStorageMock, getLogo(QString("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa0"))).WillOnce(Return(&logo1));
    EXPECT_CALL(*logosStorageMock, getLogo(QString("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1"))).WillOnce(Return(&logo2));
    EXPECT_CALL(*logosStorageMock, getLogo(QString("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2"))).WillOnce(Return(&logo3));
    EXPECT_CALL(*logosStorageMock, readUnlock());

    database->assignLogos(stocks);

    // clang-format off
    ASSERT_EQ(stocks.size(),                                  3);
    ASSERT_EQ(stocks.at(0)->meta.instrumentId,                "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa0");
    ASSERT_EQ(stocks.at(0)->meta.instrumentLogo,              &logo1);
    ASSERT_EQ(stocks.at(0)->meta.instrumentTicker,            "TEST");
    ASSERT_EQ(stocks.at(0)->meta.instrumentName,              "abc");
    ASSERT_EQ(stocks.at(0)->meta.forQualInvestorFlag,         true);
    ASSERT_EQ(stocks.at(0)->meta.lot,                         1);
    ...
    // clang-format off
    ASSERT_EQ(stocks.at(1)->meta.instrumentId,                "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1");
    ASSERT_EQ(stocks.at(1)->meta.instrumentLogo,              &logo2);
    ASSERT_EQ(stocks.at(1)->meta.instrumentTicker,            "MAGA");
    ASSERT_EQ(stocks.at(1)->meta.instrumentName,              "def");
    ASSERT_EQ(stocks.at(1)->meta.forQualInvestorFlag,         false);
    ASSERT_EQ(stocks.at(1)->meta.lot,                         10);
    ...
    // clang-format off
    ASSERT_EQ(stocks.at(2)->meta.instrumentId,                "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2");
    ASSERT_EQ(stocks.at(2)->meta.instrumentLogo,              &logo3);
    ASSERT_EQ(stocks.at(2)->meta.instrumentTicker,            "HNYA");
    ASSERT_EQ(stocks.at(2)->meta.instrumentName,              "aaaa");
    ASSERT_EQ(stocks.at(2)->meta.forQualInvestorFlag,         true);
    ASSERT_EQ(stocks.at(2)->meta.lot,                         100);
...
TEST_F(Test_StocksDatabase, Test_writeStocksMeta)
{
    ...
    const QString stocksStr =
        "[{\"dividends\":{\"createTimestamp\":1735678800000,\"paymentTimestamp\":1738357200000,\"price\":\"100.00\",\"yield\":"
        "\"10.00\"},\"forQualInvestorFlag\":true,\"ignore\":true,\"instrumentId\":\"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa\","
        "\"instrumentName\":\"abc\",\"instrumentTicker\":\"TEST\",\"lastTradeTime\":\"18:39:00\",\"lot\":1,\"minPriceIncrement\":"
        "\"0.1\",\"pricePrecision\":1,\"shorts\":{\"enabled\":true,\"lastEnabledTimestamp\":1735678800000},\"turnover\":2000},{"
        "\"dividends\":{\"createTimestamp\":1738357200000,\"paymentTimestamp\":1740776400000,\"price\":\"150.00\",\"yield\":\"15."
        "00\"},\"forQualInvestorFlag\":false,\"ignore\":true,\"instrumentId\":\"bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb\","
        "\"instrumentName\":\"def\",\"instrumentTicker\":\"MAGA\",\"lastTradeTime\":\"23:49:00\",\"lot\":10,"
        "\"minPriceIncrement\":\"0.01\",\"pricePrecision\":2,\"shorts\":{\"enabled\":true,\"lastEnabledTimestamp\":1738357200000}"
        ",\"turnover\":5000000},{\"dividends\":{\"createTimestamp\":1740776400000,\"paymentTimestamp\":1743454800000,\"price\":"
        "\"200.00\",\"yield\":\"20.00\"},\"forQualInvestorFlag\":true,\"ignore\":true,\"instrumentId\":\"cccccccc-cccc-cccc-cccc-"
        "cccccccccccc\",\"instrumentName\":\"aaaa\",\"instrumentTicker\":\"HNYA\",\"lastTradeTime\":\"09:59:00\",\"lot\":100,"
        "\"minPriceIncrement\":\"0.001\",\"pricePrecision\":3,\"shorts\":{\"enabled\":true,\"lastEnabledTimestamp\":"
        "1740776400000},\"turnover\":9000000000}]";
