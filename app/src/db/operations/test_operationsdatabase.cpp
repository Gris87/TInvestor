...
TEST_F(Test_OperationsDatabase, Test_readOperations)
{
    ...
    for (int i = 0; i < operations.size(); ++i)
    {
        ...
        ASSERT_EQ(operations.at(i).fifoItems.at(0).cost,              Quotation(32, 33));
        ...
        ASSERT_EQ(operations.at(i).costFifo,                          Quotation(9, 10));
        ASSERT_EQ(operations.at(i).costWavg,                          Quotation(11, 12));
        ...
        ASSERT_EQ(operations.at(i).totalMoney,                        Quotation(26, 27));
...
TEST_F(Test_OperationsDatabase, Test_writeOperations)
{
    ...
    operation.costFifo                        = Quotation(9, 10);
    operation.costWavg                        = Quotation(11, 12);
    ...
    operation.totalMoney                      = Quotation(26, 27);
