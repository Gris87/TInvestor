...
win32* {
    ...
    copy_qt_files.commands += $(COPY_FILE) "$$shell_path($$(QTDIR)/bin/Qt6Graphs$${DEBUG_SUFFIX}.dll)" "$$shell_path($${OUT_PWD}/build)" &&
    ...
    copy_qt_files.commands += $(COPY_FILE) "$$shell_path($$(QTDIR)/bin/Qt6Quick$${DEBUG_SUFFIX}.dll)" "$$shell_path($${OUT_PWD}/build)" &&
    copy_qt_files.commands += $(COPY_FILE) "$$shell_path($$(QTDIR)/bin/Qt6QuickWidgets$${DEBUG_SUFFIX}.dll)" "$$shell_path($${OUT_PWD}/build)" &&
    copy_qt_files.commands += $(COPY_FILE) "$$shell_path($$(QTDIR)/bin/Qt6Quick3D$${DEBUG_SUFFIX}.dll)" "$$shell_path($${OUT_PWD}/build)" &&
    copy_qt_files.commands += $(COPY_FILE) "$$shell_path($$(QTDIR)/bin/Qt6ShaderTools$${DEBUG_SUFFIX}.dll)" "$$shell_path($${OUT_PWD}/build)" &&
    ...
    copy_qt_files.commands += $(COPY_FILE) --no-dereference "$$shell_path($$(QTDIR)/lib/libQt6Graphs.so*)" "$$shell_path($${OUT_PWD}/build)" &&
    ...
    copy_qt_files.commands += $(COPY_FILE) --no-dereference "$$shell_path($$(QTDIR)/lib/libQt6Quick.so*)" "$$shell_path($${OUT_PWD}/build)" &&
    copy_qt_files.commands += $(COPY_FILE) --no-dereference "$$shell_path($$(QTDIR)/lib/libQt6QuickWidgets.so*)" "$$shell_path($${OUT_PWD}/build)" &&
    copy_qt_files.commands += $(COPY_FILE) --no-dereference "$$shell_path($$(QTDIR)/lib/libQt6Quick3D.so*)" "$$shell_path($${OUT_PWD}/build)" &&
    copy_qt_files.commands += $(COPY_FILE) --no-dereference "$$shell_path($$(QTDIR)/lib/libQt6ShaderTools.so*)" "$$shell_path($${OUT_PWD}/build)" &&
