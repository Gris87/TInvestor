 ...
 */
bool ConditionalFormatting::addHighlightCellsRule(
    HighlightRuleType type, const QString& formula1, const QString& formula2, const Format& format, bool stopIfTrue
)
{
    if (format.isEmpty())
    {
 ...
 */
bool ConditionalFormatting::addHighlightCellsRule(
    HighlightRuleType type, const QString& formula, const Format& format, bool stopIfTrue
)
{
 ...
 */
bool
ConditionalFormatting::add3ColorScaleRule(const QColor& minColor, const QColor& midColor, const QColor& maxColor, bool stopIfTrue)
{
    ValueObjectType type1 = VOT_Min;
