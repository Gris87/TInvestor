...
#include "src/qxlsx/xlsxdocpropsapp_p.h"
#include "src/qxlsx/xlsxdocpropscore_p.h"
#include "src/qxlsx/xlsxdocument_p.h"
...
#include "src/qxlsx/xlsxtheme_p.h"
...
#include "src/qxlsx/xlsxzipreader_p.h"
#include "src/qxlsx/xlsxzipwriter_p.h"
...
bool DocumentPrivate::savePackage(QIODevice* device) const
{
    ...
    for (int i = 0; i < workbook->drawings().size(); ++i)
    {
        ...
        {
            zipWriter.addFile(
                QStringLiteral("xl/drawings/_rels/drawing%1.xml.rels").arg(i + 1), drawing->relationships()->saveToXmlData()
            );
        }
    }
